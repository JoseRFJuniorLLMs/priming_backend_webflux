...
public class StudentCollection {
    ...
    public StudentCollection(String id, String name, String email, String tax_identification_number, String personal_identification_number, String login, String password, Status status, List<String> course, List<String> prime) {
        this.id = id;
        this.name = name;
        this.email = email;
